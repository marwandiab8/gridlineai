...
const EVENT_LABELS = {
  ...
  finish_spotify: "Stopped listening to Spotify",
  start_drive: "Started driving",
  finish_drive: "Finished driving",
...
const EVENT_TYPE_ALIASES = {
  ...
  finish_spotify: "finish_spotify",
  finished_spotify: "finish_spotify",
  spotify_finished: "finish_spotify",
  stop_spotify: "finish_spotify",
  stopped_spotify: "finish_spotify",
  spotify_stopped: "finish_spotify",
  end_spotify: "finish_spotify",
  ended_spotify: "finish_spotify",
  stop_listening_to_spotify: "finish_spotify",
  stopped_listening_to_spotify: "finish_spotify",
  finished_listening_to_spotify: "finish_spotify",
  spotify_listening_stopped: "finish_spotify",
  start_drive: "start_drive",
  started_drive: "start_drive",
  start_driving: "start_drive",
  started_driving: "start_drive",
  begin_drive: "start_drive",
  drive_started: "start_drive",
  driving_started: "start_drive",
  car_connected: "start_drive",
  connected_to_car: "start_drive",
  connected_to_carplay: "start_drive",
  finish_drive: "finish_drive",
  finished_drive: "finish_drive",
  finish_driving: "finish_drive",
  finished_driving: "finish_drive",
  stop_drive: "finish_drive",
  stopped_drive: "finish_drive",
  stop_driving: "finish_drive",
  stopped_driving: "finish_drive",
  end_drive: "finish_drive",
  ended_drive: "finish_drive",
  drive_finished: "finish_drive",
  driving_finished: "finish_drive",
  car_disconnected: "finish_drive",
  disconnected_from_car: "finish_drive",
  disconnected_from_carplay: "finish_drive",
